...
const gridBackgroundColor: string = "cyan"
...
const StudentDashboard = () => {
  return (
      ...
      >
        ...
        <GridItem h="70vh" rowSpan={1} colSpan={1} bg="blue">
          <Interactions />
        </GridItem>
          
        {/* ACHIEVEMENTS PANE */}
        <GridItem rowSpan={1} colSpan={1} bg="orange">
          <Achievements />
        </GridItem>
        ...
        <GridItem rowSpan={1} colSpan={2} bg="grey">
          <Previous />
        </GridItem>
      </Grid>
  )
